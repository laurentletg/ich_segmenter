"""
 ...
 \file   GeNeuroSegmenter.py
 \author Maxime Bouthillier (MB)
...
class GeNeuroSegmenter(ScriptedLoadableModule):
    """
    ...
    def __init__(self, parent):
        ...
        self.parent.helpText = """
            ...
            "GeNeuroSegmenter">module documentation</a>.
            """
...
class GeNeuroSegmenterWidget(ScriptedLoadableModuleWidget,
                              VTKObservationMixin):
    ...
    def setup(self):
        ...
        # self.layout.
        # MB COMMENT: segmenter ui version could be adjusted.
        ...
        self.logic = GeNeuroSegmenterLogic()
    ...
    def saving_shortcut(self):
        self.enter_function("saving_shortcut")
        self.save_segmentation()
    ...
    def get_all_labels(self):
        self.enter_function("get_all_labels")
        list_of_labels = []
    ...
    def select_output_dir(self):
        ...
        all_cases_filepath = f'{self.output_folder}{os.sep}all_cases.yaml'
        all_cases_data = {
    ...
    def assess_segmentation(self):
        ...
        folder_path = self.GTFolder
        version_ref = self.check_if_file_version_exists(filename, folder_path)
    ...
    def get_results(self):
        ...
        self.compute_dice_score(dice_score_tuple_list, volume_node_an)
        ...
        for element in dice_score_tuple_list:
            ...
            for label in list_of_labels:
                if label in element[1]:
                    dice_score_results_dict[label] = dice_score
    ...
    def toggle_visibility(self):
        ...
        if self.ui.TGToggleVisibility.isChecked():
            self.ui.TGToggleVisibility.setStyleSheet(
                "background-color : indianred")
            self.ui.TGToggleVisibility.setText('Visibility: OFF')
            self.segmentation_node.GetDisplayNode().SetAllSegmentsVisibility(
                False)
        else:
            self.ui.TGToggleVisibility.setStyleSheet(
                "background-color : lightgreen")
            self.ui.TGToggleVisibility.setText('Visibility: ON')
            self.segmentation_node.GetDisplayNode().SetAllSegmentsVisibility(
                True)
...
# import vtk
# import slicer
#Note that the naming convention PEP8 has not been applied to the following code
...
class GeNeuroSegmenterLogic(ScriptedLoadableModuleLogic):
    pass

class GeNeuroSegmenterTest(ScriptedLoadableModuleTest):
    """
  ...
  """
    ...
    """
        self.setUp()
        self.test_GeNeuroSegmenter1()

    def test_GeNeuroSegmenter1(self):
